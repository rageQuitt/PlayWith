...
class OrdersDetailsRepository extends ServiceEntityRepository
{
    ...
    public function create(Orders $orders, Products $products, bool $flush = false): OrdersDetails
    {
        ...
        $this->getEntityManager()->persist($ordersDetails);
    ...
    // Ici vous pouvez garder vos autres méthodes comme findByExampleField et findOneBySomeField
